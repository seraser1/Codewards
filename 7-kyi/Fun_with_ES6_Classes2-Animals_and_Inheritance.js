...
class Shark extends Animal {
    constructor(/* Insert your parameters here */name, age, status) {
      super(/* Make a call to the parent class's constructor with the correct arguments */name, age, 0, 'shark', status);
    }
  }
...
//   const cat = new Cat('sharik', 11, 'Free')
