...
function animals(heads, legs){
    ...
    if(chickens % 1 === 0 && cows % 1 === 0) {
        if(chickens >= 0 && cows >= 0) return [chickens, cows]
...
console.log(animals(72, 200));   // Вывод: [44, 28]
console.log(animals(72, 201));   // Вывод: "No solutions"
console.log(animals(0, 0));      // Вывод: [0, 0]
console.log(animals(-1, 10));    // Вывод: "No solutions"
console.log(animals(-370, 424)); // Вывод: "No solutions"
